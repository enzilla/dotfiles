/**
 * Syncs Pi's theme with the active Omarchy light/dark mode.
 *
...
function omarchyPiTheme(): "kanagawa-violet" | "light" {
  return existsSync(lightModePath) ? "light" : "kanagawa-violet";
}
